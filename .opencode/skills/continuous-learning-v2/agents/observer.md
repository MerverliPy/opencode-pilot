...
A background agent that analyzes observations from OpenCode sessions to detect patterns and create instincts.
...
Reads observations from `~/.opencode/homunculus/observations.jsonl`:
...
Creates/updates instincts in `~/.opencode/homunculus/instincts/personal/`:

...
```bash
python3 "${OPENCODE_PLUGIN_ROOT}/skills/continuous-learning-v2/scripts/instinct-cli.py" status
```

Or if `OPENCODE_PLUGIN_ROOT` is not set (manual installation), use:
...
1. Read all instinct files from `~/.opencode/homunculus/instincts/personal/`
2. Read inherited instincts from `~/.opencode/homunculus/instincts/inherited/`

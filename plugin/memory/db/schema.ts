/**
 * SQLite schema for the agent memory plugin.
 * All DDL is here; database.ts runs these in order on first open / migration.
 */
...
export type MemoryCategory = 'preference' | 'fact' | 'code_pattern' | 'decision';

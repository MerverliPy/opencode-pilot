  ...
  return (
    ...
    >
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 6, gap: 8 }}>
        ...
        >
          <Text style={{ color: catColor, fontFamily: fonts.mono, fontSize: 9, letterSpacing: 0.5 }}>
        ...
        <Text style={{ color: colors.mutedAlt, fontFamily: fonts.mono, fontSize: 9, marginLeft: 'auto' }}>
      ...
      <View style={{ flexDirection: 'row', gap: 16, marginTop: 10 }}>
        <Pressable onPress={() => onPin(memory.id, !memory.isPinned)} hitSlop={8}>
          <Text style={{ color: memory.isPinned ? colors.accent : colors.muted, fontFamily: fonts.mono, fontSize: fontSizes.xs }}>
        ...
        <Pressable onPress={() => onDelete(memory.id)} hitSlop={8}>
          <Text style={{ color: colors.error, fontFamily: fonts.mono, fontSize: fontSizes.xs }}>
            delete
          </Text>
        </Pressable>
      </View>

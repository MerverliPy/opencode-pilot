...
jest.mock("@/plugin/memory/embeddings/similarity", () => ({
  topK: jest.fn(),
}));

// ── Imports ──────────────────────────────────────────────────────────────────

import { MemoryInjector } from "@/plugin/memory/injection/MemoryInjector";
import { getMemoriesByServer } from "@/plugin/memory/db/MemoryRepository";
import { getEmbeddingsByModel } from "@/plugin/memory/db/EmbeddingRepository";
import { createProviderFromConfig } from "@/plugin/memory/embeddings/EmbeddingProviderFactory";
import { topK } from "@/plugin/memory/embeddings/similarity";
